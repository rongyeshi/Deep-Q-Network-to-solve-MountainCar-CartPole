...
class DQN_Agent():
    ...
    def train(self):
        ...
        flag = 0
        perform_cross_time=[]
        #env_test = gym.make(self.environment_name)
        ...
        while True:
            ...
            while True:
                ...
                for i in list(range(0,len(minibatch))):
                    ...
                    if self.environment_name=='MountainCar-v0':
                        ...
                        targets[i, action_t]= reward_t + (1-int(terminal_t)) * gamma * max(Q_sa)
                ...
                if self.environment_name=='CartPole-v0' and itera % int(self.iteration/3.0)==0:
                    ...
                    self.QNet.model.save("save/"+self.environment_name+"LRM"+str(itera)+".h5")
            ...
            if self.environment_name == 'MountainCar-v0' and episode % int(self.episode/3.0)==0:
                    ...
                    self.QNet.model.save("save/"+self.environment_name+"LRM"+str(episode)+".h5")

            
            if self.environment_name == 'MountainCar-v0' and episode % 4==0:
            ...
            if episode % 20==0:
                self.QNet.model.save("save/"+self.environment_name+"LRM.h5")
                #print("Average loss:",sum(average_loss) / float(len(average_loss)))
                #
                #kk = self.test_in_train(env_test1 = env_test,numb=20)
                episode2=0
